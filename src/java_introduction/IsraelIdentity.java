...
public class IsraelIdentity {
	 ...
	 *         digits as is for odd indexes (1, 3, 5, 7, 9) digit = digit * 2,
	 *         if > 9 the sum of inner digits is taken example, 
	 * 123456782 => 1+4(2*2)+3+8(4*2)+5+3(6*2=12=>1+2)+7+7(8*2=16=>1+6)+2
	 */
